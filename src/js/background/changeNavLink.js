const changeNavLinkColor = window.addEventListener('scroll', function () {
    ...
    const nextSectionTop2 = document.querySelector('.post').offsetTop;
    ...
    if (window.scrollY >= nextSectionTop && window.scrollY < nextSectionTop2) {
        ...
        // Коли прокрутка не знаходиться між двома секціями
        navLink.forEach(function (link) {
...
export default changeNavLinkColor;
